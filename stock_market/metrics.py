    ...
    def get_sp500_historical_shares_outstanding():
        ...
        return {'ABMD': pd.Series([45062665, 44956959, 45047262, 45189883, 45230966, 45295979, 45380233, 45497490,
                ...
                'GOOG': pd.Series([340979832, 336162278, 333631113, 329867212, 327556472, 323580001, 320168491,
                                   ...
                                   5801000000, 5725000000, 5671000000, 5617000000, 5585000000, 5534000000, 5497000000],
                                  index=pd.DatetimeIndex(['2020-01-27', '2020-04-21', '2020-07-23', '2020-10-22',
                                                          ...
                                                          '2024-01-23', '2024-04-18', '2024-07-16', '2024-10-22',
                                                          '2025-01-28']).map(last_bd)),
                'GOOGL': pd.Series([299895185, 300050444, 300471156, 300643829, 300737081, 300746844, 301084627,
                                    ...
                                    5933000000, 5918000000, 5893000000, 5874000000, 5859000000, 5843000000, 5833000000],
                                   index=pd.DatetimeIndex(['2020-01-27', '2020-04-21', '2020-07-23', '2020-10-22',
                                                           '2021-01-26', '2021-04-20', '2021-07-20', '2021-10-19',
                                                           '2022-01-25', '2022-04-19', '2022-07-15', '2022-07-22',
                                                           '2022-10-18', '2023-01-26', '2023-07-18', '2023-10-17',
                                                           '2024-01-23', '2024-04-18', '2024-07-16', '2024-10-22',
                                                           '2025-01-28']).map(last_bd)),
                'HBI': pd.Series([362455755, 348035310, 348160775, 348324092, 348804893, 349115441, 349151708,
                                  349204513],
                                 index=pd.DatetimeIndex(['2020-01-31', '2020-04-24', '2020-07-24', '2020-10-30',
                                                         '2021-01-29', '2021-05-07', '2021-07-30', '2021-10-29'])
                                 .map(last_bd)),
                ...
                'IPG': pd.Series([387824443, 389613926, 389922896, 390034693, 390677929, 393375648, 393620225,
                                  393755260, 393959960, 393664189, 391028246, 388524718, 385107739, 386032784,
                                  384934698, 383004131, 378725237, 377423506, 375590566, 372508618, 372649160,
                                  369734706, 366266390, 363328974],
                                  index=pd.DatetimeIndex(['2020-02-13', '2020-04-15', '2020-06-15', '2020-10-15',
                                                          '2021-02-11', '2021-04-15', '2021-06-15', '2021-10-15',
                                                          '2022-02-15', '2022-04-18', '2022-07-18', '2022-10-18',
                                                          '2023-02-15', '2023-04-18', '2023-07-18', '2023-10-18',
                                                          '2024-02-15', '2024-04-18', '2024-07-18', '2024-10-18',
                                                          '2025-02-14', '2025-04-17', '2025-07-18', '2025-10-31'])
                                 .map(last_bd)),
                ...
                'K': pd.Series([342054365, 342670027, 342919265, 343712976, 343950311, 340496336, 340878954, 341122803,
                                341674873, 337872583, 340113095, 341281145, 341830292, 342758421, 342346679, 342519743,
                                340678265, 341883645, 342287795, 344697894, 345215923, 346939074, 347669200, 347932629],
                                 index=pd.DatetimeIndex(['2020-01-25', '2020-03-28', '2020-06-27', '2020-09-26',
                                                         '2021-01-30', '2021-04-03', '2021-07-03', '2021-10-02',
                                                         '2022-01-29', '2022-04-02', '2022-07-02', '2022-10-01',
                                                         '2023-01-28', '2023-04-01', '2023-07-01', '2023-10-28',
                                                         '2024-01-27', '2024-04-27', '2024-06-29', '2024-09-28',
                                                         '2025-01-25', '2025-03-29', '2025-06-28', '2025-09-27'])
                                 .map(last_bd)),
